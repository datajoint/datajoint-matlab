...
%                 end
    ...
    methods (Test)
        function TestFetch_testVariousDatatypes(testCase)
            ...
            testCase.verifyEqual(res(1).datetime,  '2019-12-17 13:38:00');
        ...
        function TestFetch_testNullable(testCase)
            ...
            testCase.verifyEqual(res(1).datetime,  '');
            ...
            q = University.A & 'id<6';
            [id, string_fetch, datetime_fetch, number, blob] = q.fetchn('id', 'string', ...
                'datetime', 'number', 'blob', 'ORDER BY id DESC');

            testCase.verifyEqual(id(1),  5);
            testCase.verifyEqual(string_fetch{1},  '');
            testCase.verifyEqual(datetime_fetch{1},  '');
